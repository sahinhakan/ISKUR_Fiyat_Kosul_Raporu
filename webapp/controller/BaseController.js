sap.ui.define([
	...
	return Controller.extend("com.iskur.sd.ZSDFiyatKosulRaporu.controller.BaseController", {
		/**
		...
		addMessages: function (oMessage) {
			this.getOwnerComponent()._messageManager.addMessages(oMessage);
		}
